...
#middle pokemon, (flipped)left, right: display names 
...
def game_loop():
    ...
    while not done:
        ...
        #blit characters
        SCREEN.blit(poke1, (screenWidth//2,screenHeight//2))
        SCREEN.blit(flipImage(poke2), (screenWidth//2 - 100,screenHeight//2))
        SCREEN.blit(poke3, (screenWidth//2 + 100,screenHeight//2))
